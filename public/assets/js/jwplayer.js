...
*/ window.jwplayer = (function (t) {
              ...
              if (Array.isArray(n) && n.length)
                for (var u = Object(i.f)(t.get("item"), n.length), a = Object(i.c)(Object(r.a)(n[u]), t), c = 0; c < a.length; c++)
                  for (var s = a[c], l = t.getProviders(), f = 0; f < o.a.length; f++) {
                    var d = o.a[f];
                    if (l.providerSupports(d, s)) return d.name === e;
                  }
              return !1;
            })(t, "html5");
          if (e && s && f)
  ...
  function (t, e, n) {
    ...
    function d(t, e, n) {
      var i = t.getProviders(),
        u = t.get("preload"),
        a = Object(r.j)({}, e);
      if (((a.preload = o(e.preload, u)), (a.allSources = v(e, t)), (a.sources = g(a.allSources, i)), a.sources.length))
        return (
  ...
  function (t, e, n) {
    ...
    e.a = function (t) {
      ...
      e.sources !== Object(e.sources) || a(e.sources) || (e.sources = [Object(i.a)(e.sources)]),
        (a(e.sources) && 0 !== e.sources.length) || (t.levels ? (e.sources = t.levels) : (e.sources = [Object(i.a)(t)]));
      ...
      return (
        ...
        a(e.tracks) || (e.tracks = []),
        a(e.captions) && ((e.tracks = e.tracks.concat(e.captions)), delete e.captions),
  ...
  function (t, e, n) {
    ...
    var r =
      "8.15.1+commercial_v8-15-1.400.commercial.22eba28.hlsjs.1fd238c.hlsjsprogressive.06278c3.jwplayer.98dfaff.dai.07e1a38.freewheel.af0c077.googima.3bea836.googimanvmp.6873d1e.headerbidding.c9c5d84.vast.12203f2.analytics.12eed63.gapro.141397a";
  },
  function (t, e, n) {
    "use strict";
    var r = n(0),
  ...
  function (t, e, n) {
            ...
            if ((clearTimeout(c), t.el))
              if ((k(t), O(t, "window"), t.dragged)) (t.dragged = !1), x(t, i.t, n);
                ...
                !(function (t, e, n) {
                  ...
                  o ? x(t, i.n, n) : (x(t, i.sb, n), "touchend" !== n.type || p || S(n));
              }
          };
    ...
    var y = {
      ...
      over: function (t) {
        (f || d) &&
          w(t, i.Z, f ? "pointerover" : "mouseover", function (e) {
      ...
      out: function (t) {
        if (f) {
          ...
          d &&
            w(t, i.Y, "mouseout", function (e) {
              x(t, i.Y, e);
            });
      },
      move: function (t) {
        (f || d) &&
          w(t, i.W, f ? "pointermove" : "mousemove", function (e) {
  ...
  function (t, e, n) {
    ...
    function s(t) {
      return (
        r ||
        (((navigator.requestMediaKeySystemAccess && MediaKeySystemAccess.prototype.getConfiguration) || window.MSMediaKeys) && Object(i.a)(t)("drm")
      ...
      choose: function (t) {
        if (t === Object(t))
          for (var e = i.a.length, n = 0; n < e; n++) {
            var r = i.a[n];
            if (this.providerSupports(r, t)) return { priority: e - n - 1, name: r.name, type: t.type, providerToCheck: r, provider: u.a[r.name] };
          }
        return {};
      },
    });
      ...
      s = function (t, e) {
        for (var n = "default", o = [], u = [], a = 0; a < t.childNodes.length; a++) {
          ...
          if ("jwplayer" === s.prefix) {
            var l = Object(r.b)(s);
            "source" === l
              ? (delete e.sources, o.push({ file: Object(i.j)(s, "file"), default: Object(i.j)(s, n), label: Object(i.j)(s, "label"), type: Object(i.j)(s, "type") }))
              : "track" === l
                ? (delete e.tracks, u.push({ file: Object(i.j)(s, "file"), default: Object(i.j)(s, n), kind: Object(i.j)(s, "kind"), label: Object(i.j)(s, "label") }))
  ...
  function (t, e, n) {
    ...
    var r = { audioMode: !1, flashBlocked: !1, itemMeta: {}, playbackRate: 1, playRejected: !1, state: n(3).nb, itemReady: !1, controlsEnabled: !1 },
  ...
  function (t, e, n) {
    ...
    var b = function (t, e) {
      ...
      if (
        ("free" === w.edition() &&
          (y = Object(r.j)(
            { skin: { active: "#ff0046", timeslider: { progress: "none" } }, logo: { position: "control-bar", file: d.a } },
            o.a,
            Object(r.D)(y, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"])
          )),
          (y.key = j),
          (y.edition = O),
          (y.error = w.error()),
      ...
      if (
        ((y.flashplayer = (function (t) {
          ...
          (y.related = (function (t) {
            ...
            return Object(r.j)({}, n, { disableRelated: i, showButton: o, oncomplete: a, autoplaytimer: c, shouldAutoAdvance: l });
          })(y)),
          y.ab &&
          (y.ab = (function (t) {
            var e = t.ab;
      ...
      return (
        ...
        ((b = y.playlist), /\.jwplatform.com|\.jwplayer.com/.test(b)) &&
        (y.playlist = ((f = y.playlist), (f += (-1 !== f.indexOf("?") ? "&" : "?") + "page_domain=" + encodeURIComponent(Object(p.a)())))),
        y
      );
    },
      y = n(10),
    ...
    function M(t) {
      ...
      if (n && n.code === c.a) {
        ...
        if (i > 0 && i < 4 && r && o.duration() > -7776e6)
          return new C.a("//content.jwplatform.com/libraries/" + r + ".js")
            .load()
            .then(function () {
    ...
    var N = function (t) {
      ...
      if (
        ...
        return new C.a(e, !0).load().catch(function (t) {
          return t;
        });
      }
      return Promise.resolve();
      ...
      R = function (t) {
        var e = t.attributes,
          ...
          o = e.intl,
          u = Object(P.c)(i, o, n);
        return !Object(P.h)(n) || Object(P.f)(u)
          ? Promise.resolve()
          : new Promise(function (i) {
            return Object(P.i)(r, n)
              .then(function (n) {
                var r = n.response;
                if (!E(t)) {
    ...
    var G = function (t) {
      (this._events = {}),
        (this.modelShim = new U.a()),
        (this.modelShim._qoeItem = new z.a()),
        (this.mediaShim = {}),
        (this.setup = new D(this.modelShim)),
    ...
    Object(r.j)(G.prototype, {
          ...
          this.setup
            ...
            .then(function (t) {
              ...
              if (n.setup) {
                ...
                var l = n._model;
                return (
                  i.off("change:errorEvent", tt),
                  l.on("change:errorEvent", tt),
                  o.track(l),
      ...
      playerDestroy: function () {
        this.apiQueue && this.apiQueue.destroy(),
          ...
          this.currentContainer !== this.originalContainer && nt(this, this.originalContainer),
          this.off(),
  ...
  function (t, e, n) {
    ...
    var N = I,
      ...
      H = r.f.extend,
      Q = {};
    (Q._ = r.f), (Q.utils = Object(r.j)(T.a, { key: D.b, extend: H, scriptloader: B.a, rssparser: { parse: q.a }, tea: z.a, UI: R.a })), (Q.utils.css.style = Q.utils.style), (Q.vid = V.a);
    var W = Q,
      U = n(66),
      X = /^(?:on(?:ce)?|off|trigger)$/;
    function Y(t) {
